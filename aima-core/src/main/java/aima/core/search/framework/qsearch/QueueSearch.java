...
public abstract class QueueSearch<S, A> {
	...
	public static final String METRIC_NODES_EXPANDED_REINSERTED_IN_FRONTIER = "nodesExpandedAndReinserted";
	public static final String METRIC_NODES_DUPLICATED_IN_FRONTIER = "nodesDuplicated";
	//Ejercicios 5 y 6
	
	public static final String METRIC_TIME_TAKEN = "metricTime";
